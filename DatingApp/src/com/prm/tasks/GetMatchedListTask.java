...
import com.prm.datingapp.MatchedFragment;
import com.prm.datingapp.SearchFragment;

import android.os.AsyncTask;
import android.util.Log;

public class GetMatchedListTask extends AsyncTask<String, String, String> {

	private MatchedFragment activity;
	
	public GetMatchedListTask(MatchedFragment activity) {
	...
	public String updateInfo(String id) {
		...
		try {
			String url = "http://10.0.3.2:58996/Matched/GetMatchedPeople";
