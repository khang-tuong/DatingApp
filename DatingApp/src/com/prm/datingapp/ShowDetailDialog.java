...
public class ShowDetailDialog extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		Button btnClose = (Button) v.findViewById(R.id.show_detail_dialog_btnClose);
		ImageView image = (ImageView) v.findViewById(R.id.show_detail_dialog_image);
		TextView txtName = (TextView) v.findViewById(R.id.show_detail_dialog_txtName);
		TextView txtDescription = (TextView) v.findViewById(R.id.show_detail_dialog_txtDescription);
